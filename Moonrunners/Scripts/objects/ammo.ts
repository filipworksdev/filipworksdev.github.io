module objects {
    export class Ammo {
        private _ammoImage: objects.GameObject[];
        private _ammoCountText: objects.GameObject[];
        ...
        get ammoImages() : objects.GameObject[] {
            return this._ammoImage;
        }

        get ammoText() : objects.GameObject[] {
            return this._ammoCountText;
        }

        public setAmmoText(who: "Player1" | "Player2", count: number) {
